        ...
        <div className='container relative'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className='md:col-span-1 flex flex-col justify-center'>
                    <h1 className='text-muted-foreground flex-col text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold leading-normal'>Hello, My Name is <br/> <strong className='text-blue-500 '>Kongkon Jowarder</strong></h1>
                    <p className='section-title text-base xl:text-lg font-normal leading-normal mt-[10px]'>I'm a passionate web developer with expertise in React, Next.js, and modern web technologies. I love creating beautiful and functional website that solve real world problems.</p>
